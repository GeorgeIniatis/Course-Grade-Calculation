    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dueDate', models.DateTimeField(blank=True, null=True, verbose_name='Due Date and Time')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('submissionDate', models.DateTimeField(blank=True, null=True, verbose_name='Submission Date and Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creditsWorth', models.IntegerField(validators=[django.core.validators.MaxValueValidator(20), django.core.validators.MinValueValidator(5)], verbose_name='Credits Worth')),
                ...
                ('minimumRequirementsForCredit', models.DecimalField(decimal_places=2, max_digits=3, verbose_name='Minimum Requirements For Credit')),
